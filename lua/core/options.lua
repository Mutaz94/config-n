...
vim.o.writebackup = false -- If a file is being edited by another pro:gram (or was written to file while editing with another program), it is not allowed to be edited (default: true)
